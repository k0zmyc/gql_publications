...
import requests
from gql_publications.utils.gql_ug_proxy import createProxy
...
from gql_publications.utils.Dataloaders import getUgConnection, getLoadersFromInfo
...
def RoleBasedPermission(roles: str = "", whatreturn=[]):
    ...
    from gql_publications.GraphTypeDefinitions.externals import RBACObjectGQLModel
