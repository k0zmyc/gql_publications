...
def resolve_publication_reference(self) -> str:
    return self.publication_reference
...
@strawberry.field(description="""The user / participant""", permission_classes=[OnlyForAuthentized()])
